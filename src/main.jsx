  ...
  return <>
    ...
    <main id="top">
      ...
      <section className="manifesto" id="about" aria-labelledby="about-title">
        ...
        <div><h2 id="about-title">Learning to become<br />the bridge.</h2><p className="intro">After a 20-year career in marketing in the consumer packaged goods (CPG) industry, I am turning toward art, craft, and interiors, developing the discernment and relationships this next chapter calls for.</p><div className="story-copy" id="path"><p>My foundation is in international business, with a bachelor’s degree and an MBA from Universidad EAFIT in Medellín, and a master’s in corporate and multicultural communication from DePaul University in Chicago. I later earned a Brand Management Certificate through Cornell University’s online program.</p><p>My career has included brand-building work for Häagen-Dazs, Crystal Light, Country Time, and Kool-Aid. Working alongside designers and creative teams, I learned to translate consumer insights and business needs into clear creative direction—experience I now bring to exploring the relationship between craft, people, and place.</p><p>I completed the Interior Design Institute (IDI) online program to build fluency in space, materials, and design thinking—a foundation for understanding how craft and interiors speak to one another.</p><p>This was a deliberate first step before a full-time interior design diploma in Florence, Italy. Along the way, I am developing my eye, learning from makers, and building connections across the arts.</p><p>Bridging Craft is a work in progress. This page and its contents will continue to evolve as I shape my path, deepen my understanding, and discover new ways to connect craft with interiors.</p><img className="idi-logo" src={`${import.meta.env.BASE_URL}images/idi-wide.png`} alt="Interior Design Institute — Graduate" loading="lazy" /></div></div>
      </section>
