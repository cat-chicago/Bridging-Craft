  ...
  return <>
    ...
    <main id="top">
      ...
      <section className="catalog-intro" id="catalog" aria-labelledby="catalog-title">
        <p className="side-label">04 — Sample Case Study</p><div className="case-content"><h2 id="catalog-title">Craft to live with.</h2><p>Discover an evolving selection of Colombian textiles, explore the details, and gather the pieces that speak to you.</p>
          <article className="maitama-case" aria-labelledby="maitama-case-title">
            <p className="eyebrow">Sample board / Maitamá textiles</p><h3 id="maitama-case-title">A living room renewal in Florence</h3>
            <div className="case-story"><div><h4>The project</h4><p>A couple is refreshing their living room as a place to read, talk, and welcome friends. They want a calm foundation with pieces that carry a story of their own.</p></div><div><h4>The composition</h4><p>Natural linen, warm wood, and soft light. Three cushions introduce terracotta, mustard, and charcoal, while a gray throw balances the accents and adds warmth.</p></div><div><h4>Craft and heritage</h4><p>Maitamá connects the room to loom weaving and the family traditions of Sonsón, Colombia.</p></div></div>
            <figure className="case-textiles"><img src={`${import.meta.env.BASE_URL}images/case-study/textiles.webp`} alt="Maitamá textile concept: a striped cushion, a light geometric cushion, a terracotta geometric cushion, and a gray fringed throw" loading="lazy" width="1600" height="533" /><figcaption><span>01 · Striped cushion</span><span>02 · Light geometric cushion</span><span>03 · Terracotta geometric cushion</span><span>04 · Gray fringed throw</span></figcaption></figure>
            <div className="case-materials">{[['sofa','Natural linen sofa'],['table','Wooden coffee table'],['lamp','Warm lighting'],['rug','Neutral rug']].map(([image,label])=><figure key={image}><img src={`${import.meta.env.BASE_URL}images/case-study/${image}.webp`} alt={label} loading="lazy" width="1600" height="1600" /><figcaption>{label}</figcaption></figure>)}</div>
            <p className="case-disclosure">Conceptual proposal. Textile visualizations are based on catalog photographs. This sample board illustrates a possible composition, not a completed client project.</p>
          </article>
          <a className="text-link" href={`${import.meta.env.BASE_URL}catalog/`}>Explore the catalog <Arrow /></a></div>
      </section>
